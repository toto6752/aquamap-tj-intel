...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/analytics' | '/learn' | '/reports' | '/sources' | '/roadmap' | '/api/chat'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/analytics' | '/learn' | '/reports' | '/sources' | '/roadmap' | '/api/chat'
  id: '__root__' | '/' | '/analytics' | '/learn' | '/reports' | '/sources' | '/roadmap' | '/api/chat'
...
const rootRouteChildren: RootRouteChildren = {
  IndexRoute, AnalyticsRoute, LearnRoute, ReportsRoute, SourcesRoute, RoadmapRoute, ApiChatRoute,
}
